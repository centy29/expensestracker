...
namespace reciepttracker
{
    internal class recieptui
    {
            ...
            do
            {
                ...
                switch (userinput)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        if (recieptlogic.reciept.paymentmethod())//DISPLAY IF TRUE
                            RemoveExpense();
                        else
        ...
        static void AddExpenses()
        {
            ...
            recieptlogic.reciept.expenses.Add((brand, address, tin, invoice, amount));// a method for adding the input from here to store in the list
            Console.WriteLine("-------------------------------");
        ...
        static void history()
        {
            foreach (var expense in recieptlogic.reciept.expenses)//USED TO DISPLAY THE LIST OF EXPENSES NA NAINPUT OR NA ADD
            {
                Console.WriteLine("-----------------------");
